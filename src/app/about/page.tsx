...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "xoxoakarsh@gmail.com",
    href: "mailto:xoxoakarsh@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "+994407171739",
    href: "tel:994407171739",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/akarshx/",
    content: "/akarshx",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Akarsh Tripathi</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Akarsh Tripathi, a Fullstack developer passionate about
            ...
            <p className="mb-10">
              When I&apos;m not coding, you can find me Playing Chess, exploring new technologies, or sipping coffee
